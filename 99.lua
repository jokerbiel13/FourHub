...
WindUI:Popup({
    Title = "FOURHUB Loaded! - 99 Night in the Forest",
    Icon = "star",
    IconThemed = true,
    Content = "FOURHUB TEAM | Join our (dsc.gg/fourhub)",
    Buttons = {
...
local Window = WindUI:CreateWindow({
    Folder = "FOUR Config | 99NitF | V3",
    Title = "FOURHUB - 99 Night in the Forest @ In-game (Beta)",
    IconThemed = true,
    Icon = "star",
    Author = "FOURHUB (dsc.gg/fourhub)",
