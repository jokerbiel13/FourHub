...
do
    ...
    WindUI:Popup(
        {
            Title = gradient("FOURHUB Loaded! - Murder Mystery 2", Color3.fromHex("#ff0000"), Color3.fromHex("#000000")),
            Icon = "rbxassetid://137518578026159",
            Content = gradient("Thank for Support", Color3.fromHex("#ffffff"), Color3.fromHex("#ffffff")) ..
                gradient(" [FOURHUB OFFICIAL]", Color3.fromHex("#ffd700"), Color3.fromHex("#fc6600")),
            Buttons = {
    ...
    WindUI:Notify(
        {
            Title = gradient("FOURHUB", Color3.fromHex("#ff0000"), Color3.fromHex("#000000")),
    ...
    local Window =
        WindUI:CreateWindow(
        {
            Title = gradient("FOURHUB - Murder Mystery 2", Color3.fromHex("#ff0000"), Color3.fromHex("#000000")),
            Icon = "rbxassetid://137518578026159",
            Author = "Version: 2.8 | Executor",
            Folder = "WindUI",
    ...
    local function teleportToPlayer()
        if (teleportTarget and teleportTarget.Character) then
            ...
            WindUI:Notify(
                {Title = "FOURHUB", Content = "Target not found or unavailable", Icon = "x-circle", Duration = 3}
            )
        end
    end
...
Tabs.MainTab:Button({
    ...
    Tabs.SocialsTab:Paragraph(
        {
            Title = gradient("FOURHUB .GG/cUwR4tUJv3", Color3.fromHex("#ff0000"), Color3.fromHex("#000000")),
            Desc = "My Main Social",
            Image = "star",
            Color = "Red",
            Buttons = {
                {
                    Icon = "circle",
                    Title = "FOURHUB DISCORD",
                    Callback = function()
                        if pcall(setclipboard, "https://dsc.gg/fourhub") then
                            WindUI:Notify(
                                {
                                    Title = "Copied!",
    ...
    Tabs.SocialsTab:Paragraph(
        {
            Title = gradient("FOURHUB GUNS.LOL", Color3.fromHex("#ff0000"), Color3.fromHex("#000000")),
            Desc = "My Another Social",
            Image = "star",
            Color = "Red",
            Buttons = {
                {
                    Title = "FOURHUB SOCIAL",
                    Icon = "circle",
                    Callback = function()
                        if pcall(setclipboard, "https://guns.lol/jokerbiel13") then
                            WindUI:Notify(
                                {
                                    Title = "Copied!",
                                    Content = "Link copied to clipboard.",
