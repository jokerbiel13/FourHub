...
DiscordServerParagraph = Tabs.InfoTab:Paragraph({
    ...
    Desc = "Link Discord FOURHUB!",
    TextXAlignment = "Left",
    Buttons = {{
        Title = "Copy Link Discord",
        Callback = function()
            setclipboard("https://dsc.gg/fourhub");
            WindUI:Notify({
                Title = "Notication",
...
DiscordServerParagraph1 = Tabs.InfoTab:Paragraph({
    Title = "Social FOURHUB",
    Desc = "Link Social FOURHUB!",
    TextXAlignment = "Left",
    Buttons = {{
        Title = "Copy Social FOURH",
        Callback = function()
            setclipboard("https://guns.lol/jokerbiel13");
            WindUI:Notify({
                Title = "Notication",
