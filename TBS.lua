...
local Window = Rayfield:CreateWindow({
   Name = "FOURHUB | The Strongest Battleground",
   Icon = 104487529937663, -- Icon in Topbar. Can use Lucide Icons (string) or Roblox Image (number). 0 to use no icon (default).
   LoadingTitle = "FOURHUB Loaded! - TSB",
   LoadingSubtitle = "Join our at dsc.gg/fourhub",
   ShowText = "FOURHUB", -- for mobile users to unhide rayfield, change if you'd like
   ...
   Discord = {
      ...
      Invite = "cUwR4tUJv3", -- The Discord invite code, do not include discord.gg/. E.g. discord.gg/ ABCD would be ABCD
   ...
   KeySettings = {
      Title = "Key FourHub",
      Subtitle = "Key System",
      Note = "Key In Discord. dsc.gg/fourhub", -- Use this to tell the user how to get a key
      FileName = "Key", -- It is recommended to use something unique as other scripts using Rayfield may overwrite your key file
      SaveKey = true, -- The user's key will be saved, but if you change the key, they will be unable to use your script
      GrabKeyFromSite = false, -- If this is true, set Key below to the RAW site you would like Rayfield to get the key from
      Key = {"fh20"} -- List of keys that will be accepted by the system, can be RAW file links (pastebin, github etc) or simple strings ("hello","key22")
   }
})
