...
local Tabs = {
    Main = MainWindow:Tab({ Title = "Main", Icon = "eye", Desc = "FourHub" }),
    Misc = MainWindow:Tab({ Title = "Misc", Icon = "sparkles", Desc = "FourHub" }),
    Fight = MainWindow:Tab({ Title = "Fighting", Icon = "sword", Desc = "FourHub" }),
    Tech = MainWindow:Tab({ Title = "Tech", Icon = "wrench", Desc = "FourHub" }),
    Lag = MainWindow:Tab({ Title = "Lag-Ping", Icon = "leaf", Desc = "FourHub" }),
    Anim = MainWindow:Tab({ Title = "Animations", Icon = "package", Desc = "FourHub" }),
    Place = MainWindow:Tab({ Title = "Places", Icon = "map", Desc = "FourHub" }),
    Moveset = MainWindow:Tab({ Title = "Moveset", Icon = "star", Desc = "FourHub" }),
    Fling = MainWindow:Tab({ Title = "Fling", Icon = "user", Desc = "FourHub" }),
    Info = MainWindow:Tab({ Title = "Information", Icon = "badge-info", Desc = "FourHub" }),
}
...
Tabs.Main:Button({
    ...
    Locked = false,
    Callback = function()
        setclipboard("discord.gg/cUwR4tUJv3")
    end,
})
...
Tabs.Main:Button({
    Title = "FourHub Mini",
    Desc = "First version of the FourHub but rly usefull",
    Locked = true,
    Callback = function()
    ...
    if FlingFlags.notifyOnDeath and SelectedFlingTarget then
        ...
        if hum then
            FlingDeathConn = hum.Died:Connect(function()
                ShowNotification("FourHub", SelectedFlingTarget.DisplayName .. " Died")
            end)
        end
    end
end
...
local function SelectFlingTarget(name)
    ...
    if not name or name == "" then
        ShowNotification("FourHub", "No One Selected")
        return
    end
    ...
    if target then
        ...
        ShowNotification("FourHub", "Selected: " .. target.DisplayName, "https://www.roblox.com/headshot-thumbnail/image?userId=" .. target.UserId .. "&width=420&height=420&format=png", 10)
        UpdateFlingDeathNotify()
    else
        ShowNotification("FourHub", "Player Not Found...")
    end
end
...
Tabs.Fling:Button({
    ...
    Callback = function()
        setclipboard("discord.gg/cUwR4tUJv3")
        ShowNotification("FourHub", "Discord link copied to clipboard!")
    end,
})
...
Tabs.Fling:Button({
    ...
    Callback = function()
        if not SelectedFlingTarget then ShowNotification("FourHub", "No One Selected") return end
        local myRoot = LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("HumanoidRootPart")
        local tRoot = SelectedFlingTarget.Character and SelectedFlingTarget.Character:FindFirstChild("HumanoidRootPart")
        if myRoot and tRoot then
            myRoot.CFrame = tRoot.CFrame
        else
            ShowNotification("FourHub", "Could not find character to teleport.")
        end
    end,
})
...
Tabs.Fling:Toggle({
    ...
    Callback = function(state)
        ...
        if not SelectedFlingTarget then ShowNotification("FourHub", "No One Selected") FlingFlags.teleport = false return end
        task.spawn(function()
...
Tabs.Fling:Toggle({
    ...
    Callback = function(state)
        ...
        if not state then return end
        if not SelectedFlingTarget then ShowNotification("FourHub", "No One Selected") FlingFlags.fling = false return end
        task.spawn(function()
...
Tabs.Fling:Button({
    ...
    Callback = function()
        ...
        if hum then
            ...
            ShowNotification("FourHub", "Could not find the player's character to view.")
        end
    end,
})
...
Tabs.Fling:Toggle({
    ...
    Callback = function(state)
        ...
        if not SelectedFlingTarget then ShowNotification("FourHub", "No One Selected") FlingFlags.view = false return end
        task.spawn(function()
...
Tabs.Fling:Toggle({
    ...
    Callback = function(state)
        ...
        if not state then return end
        if not SelectedFlingTarget then ShowNotification("FourHub", "No One Selected") FlingFlags.aimLockCam = false return end
        task.spawn(function()
...
Tabs.Fling:Toggle({
    ...
    Callback = function(state)
        ...
        if not state then return end
        if not SelectedFlingTarget then ShowNotification("FourHub", "No One Selected") FlingFlags.aimLockChar = false return end
        task.spawn(function()
...
Tabs.Fling:Toggle({
    ...
    Callback = function(state)
        ...
        if not state then return end
        if not SelectedFlingTarget then ShowNotification("FourHub", "No One Selected") FlingFlags.orbit = false return end
...
Players.PlayerRemoving:Connect(function(p)
    if SelectedFlingTarget and p == SelectedFlingTarget then
        ShowNotification("FourHub", p.DisplayName .. " left the game")
        SelectedFlingTarget = nil
...
task.spawn(function()
    ...
    if success and response and response.guild then
        ...
        Tabs.Info:Button({
            ...
            Callback = function()
                setclipboard("discord.gg/cUwR4tUJv3" .. DiscordCode)
...
Tabs.Info:Divider()
Tabs.Info:Section({ Title = "FourHub", TextXAlignment = "Center", TextSize = 17 })
Tabs.Info:Divider()

Tabs.Info:Paragraph({
    Title = "Owner:",
    Desc = "Jokerbiel13",
    Image = "rbxassetid://16584754901",
    ImageSize = 30,
    Thumbnail = "",
    ThumbnailSize = 0,
    Locked = false,
